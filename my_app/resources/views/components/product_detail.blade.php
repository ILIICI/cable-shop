            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-img">
                        <img id="zoompro" src="{{ asset('assets/img/product-details/l1.jpg') }}" data-zoom-image="{{ asset('assets/img/product-details/bl1.jpg') }}" alt="zoom"/>
                        <div id="gallery" class="mt-12 product-dec-slider owl-carousel">
                            <a data-image="{{ asset('assets/img/product-details/l1.jpg') }}" data-zoom-image="{{ asset('assets/img/product-details/bl1.jpg') }}">
                                <img src="{{ asset('assets/img/product-details/s1.jpg') }}" alt="">
                            </a>
                            <a data-image="{{ asset('assets/img/product-details/l2.jpg') }}" data-zoom-image="{{ asset('assets/img/product-details/bl2.jpg') }}">
                                <img src="{{ asset('assets/img/product-details/s2.jpg') }}" alt="">
                            </a>
                            <a data-image="{{ asset('assets/img/product-details/l3.jpg') }}" data-zoom-image="{{ asset('assets/img/product-details/bl3.jpg') }}">
                                <img src="{{ asset('assets/img/product-details/s3.jpg') }}" alt="">
                            </a>
                            <a data-image="{{ asset('assets/img/product-details/l4.jpg') }}" data-zoom-image="{{ asset('assets/img/product-details/bl4.jpg') }}">
